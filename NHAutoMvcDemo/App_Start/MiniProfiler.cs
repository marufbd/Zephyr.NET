...
[assembly: WebActivator.PreApplicationStartMethod(
	typeof(NHAutoMvcDemo.App_Start.MiniProfilerPackage), "PreStart")]

[assembly: WebActivator.PostApplicationStartMethod(
	typeof(NHAutoMvcDemo.App_Start.MiniProfilerPackage), "PostStart")]


namespace NHAutoMvcDemo.App_Start 
{
    public static class MiniProfilerPackage
    {
        public static void PreStart()
        {
			...
			//var profiled = new ProfiledDbConnection((DbConnection)NHibernateSession.Initialize(null).Connection, MiniProfiler.Current);
