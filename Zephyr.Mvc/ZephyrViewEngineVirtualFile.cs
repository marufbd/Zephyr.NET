...
namespace Zephyr.Web.Mvc
{
    ...
    /// </summary>
    internal class ZephyrViewEngineVirtualFile
        : VirtualFile
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZephyrViewEngineVirtualFile"/> class.
        /// </summary>
        /// <param name="filePath">The filePath.</param>
        public ZephyrViewEngineVirtualFile(string filePath)
            : base(filePath)
        {
        ...
        private static Stream ReadResource(string embeddedFileName)
        {
            ...
            Assembly assembly = typeof(ZephyrViewEngineVirtualFile).Assembly;
            return assembly.GetManifestResourceStream("Zephyr.Web.Mvc.Html.DisplayTemplates." + resourceFileName);
        }
    }
}